...
app.ui.preloader = {
    ...
    preloaderHide: function(rel) {
        ...
        if (rel == 'index') {
            ...
            Modernizr.load({
                load: [path + 'magnetic.js', path + 'app-about.js'],
                complete: function() {
            ...
            Modernizr.load({
                load: [path + 'tagcanvas.js', path + 'app-skills.js'],
                complete: function() {
            ...
            Modernizr.load({
                load: [path + 'magicwall.js', path + 'app-gallery.js'],
                complete: function() {
...
Modernizr.load({
    ...
    yep: [path + 'magnetic.js', path + 'app-about.js'],
    complete: function() {
...
Modernizr.load({
    ...
    yep: [path + 'tagcanvas.js', path + 'app-skills.js'],
    complete: function() {
...
Modernizr.load({
    ...
    yep: [path + 'magicwall.js', path + 'app-gallery.js'],
    complete: function() {
